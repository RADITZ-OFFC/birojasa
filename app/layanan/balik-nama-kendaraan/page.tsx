...
const pageDescription =
  "Jasa balik nama kendaraan dengan persyaratan jelas (BPKB & STNK asli, fotocopy KTP pemilik baru, surat kuasa, cek fisik). BiroJasa Manggala Indonesia bantu proses transparan, rapi, dan hemat waktu tanpa bolak-balik. Konsultasi gratis via WhatsApp +6282115473234.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — Jasa Balik Nama Kendaraan",
      },
    ],
  },
  twitter: {
