...
const pageDescription =
  "Jasa perpanjang STNK tahunan dengan persyaratan jelas (STNK asli, KTP asli, surat kuasa) dan alur proses transparan. BiroJasa Manggala Indonesia bantu kamu tanpa antre & bolak-balik. Konsultasi gratis via WhatsApp +6282115473234.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — Jasa Perpanjang STNK Tahunan",
      },
    ],
  },
  twitter: {
