...
const pageDescription =
  "Jasa ganti nomor plat kendaraan dengan persyaratan jelas (BPKB & STNK asli, KTP asli, surat kuasa, cek fisik). BiroJasa Manggala Indonesia bantu proses transparan, rapi, dan hemat waktu tanpa bolak-balik. Konsultasi gratis via WhatsApp +6282115473234.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — Jasa Ganti Nomor Plat Kendaraan",
      },
    ],
  },
  twitter: {
