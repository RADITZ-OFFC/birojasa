...
const pageDescription =
  "Jasa mutasi masuk kendaraan (dari luar daerah) dengan persyaratan jelas dan alur transparan. Dokumen utama: BPKB & STNK asli, arsip BPKB/arsip STNK, KTP, surat kuasa, dan cek fisik. Konsultasi gratis via WhatsApp +6282115473234.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — Jasa Mutasi Masuk Kendaraan",
      },
    ],
  },
  twitter: {
