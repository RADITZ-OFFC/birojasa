...
const pageDescription =
  "Jasa perpanjang STNK 5 tahunan (ganti plat) dengan persyaratan jelas dan alur transparan, termasuk cek fisik (no rangka/no kendaraan). BiroJasa Manggala Indonesia bantu kamu tanpa antre & bolak-balik. Konsultasi gratis via WhatsApp +6282115473234.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — Jasa Perpanjang STNK 5 Tahunan",
      },
    ],
  },
  twitter: {
    ...
    <>
      ...
      <main>
        ...
        <BenefitsSummary
          ...
          subheading="Biar proses ganti plat terasa lebih ringan—ini yang kamu dapat saat dibantu BiroJasa Manggala Indonesia."
          items={[
            {
