...
const pageDescription =
  "Jasa urus STNK hilang atau rusak dengan proses rapi dan transparan. Persyaratan jelas: BPKB asli, fotocopy STNK (jika ada), KTP asli, surat kuasa, laporan kehilangan dari Polsek (untuk hilang), dan cek fisik. Konsultasi gratis via WhatsApp +6282115473234.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — Jasa STNK Hilang/Rusak",
      },
    ],
  },
  twitter: {
