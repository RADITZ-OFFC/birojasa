...
const pageDescription =
  "Jasa ubah bentuk/warna kendaraan untuk update data STNK dengan proses rapi dan transparan. Persyaratan jelas (BPKB & STNK asli, KTP, surat kuasa, cek fisik, rekomendasi bengkel resmi). Konsultasi gratis via WhatsApp +6282115473234.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — Jasa Ubah Bentuk/Warna Kendaraan",
      },
    ],
  },
  twitter: {
