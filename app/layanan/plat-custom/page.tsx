...
const pageDescription =
  "Jasa plat custom (pilih nomor) dengan proses rapi dan transparan. Persyaratan jelas: BPKB & STNK asli, KTP asli, surat kuasa, nomor yang dipilih, dan cek fisik. Konsultasi gratis via WhatsApp +6282115473234.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — Jasa Plat Custom",
      },
    ],
  },
  twitter: {
