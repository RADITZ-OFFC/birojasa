...
const pageDescription =
  "Pertanyaan yang sering ditanyakan tentang syarat, proses, estimasi, biaya, dan keamanan berkas untuk pengurusan STNK & dokumen kendaraan. Konsultasi gratis via WhatsApp +6282115473234.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — FAQ",
      },
    ],
  },
  twitter: {
...
export default function FaqPage() {
  ...
  const faqs = [
    ...
    {
      q: "Wilayah layanan BiroJasa Manggala Indonesia di mana saja?",
